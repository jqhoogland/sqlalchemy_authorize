...
"""Tests for `sqlalchemy_authorize.permissions_mixin`.

Inspired by tests in :mod:`sqlalchemy-mixins`_.

.. _sqlalchemy-mixins: <https://github.com/absent1706/sqlalchemy-mixins>
